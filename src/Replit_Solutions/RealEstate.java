...
If amount of garage spots exceeds 10 spots (grater then 10), display message:
 ...
 And if highway is in the radius from 5 mile to 20 miles (inclusive),  add to the property price 4000.  T
 hen your program should ask about nearest school rating. If school's rating is in the range from 10 (inclusive) to 8 points,
